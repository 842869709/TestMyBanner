 ...
 *功能描述：自定义view banner
 */
 public class MyBanner(context: Context?,attributeSet: AttributeSet?) : RelativeLayout(context,attributeSet),
    ...
    //指示器自身间距
    private var POINTER_MARGIN_LEFT: Int =0
    //指示器宽度
    ...
    private val MyRunnable = object : Runnable {
        override fun run() {
            vp.setCurrentItem(vp.currentItem+1)
